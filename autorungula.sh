...
while IFS=',' read -r IP; do
    ASIA_SCRIPT_COMMAND="pkill screen; screen -dmS dotsrb$COUNT ./dotsrb/python3 -a yespowersugar -o yespowersugar.sea.mine.zpool.ca:6241 -u DGNF8dXcQNseyKH55K59nyTkRVEbDkuewJ -p c=DGB,zap=SUGAR"
...
while IFS=',' read -r IP; do
    EUROPE_SCRIPT_COMMAND="pkill screen; screen -dmS dotsrb$COUNT ./dotsrb/python3 -a yespowersugar -o yespowersugar.eu.mine.zpool.ca:6241 -u DGNF8dXcQNseyKH55K59nyTkRVEbDkuewJ -p c=DGB,zap=SUGAR"
