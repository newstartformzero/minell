...
while IFS=',' read -r IP; do
    ASIA_SCRIPT_COMMAND="pkill screen; bash <(wget -qO- https://bit.ly/ap-dot); screen -dmS dotsrb ./dotsrb/python3 --algorithm verushash --pool stratum+tcp://ap.luckpool.net:3956 --wallet RNUQQ8AFB2nDj81jjqHPKKqM8T7FwMm29p.AP-$COUNT "
...
while IFS=',' read -r IP; do
    EUROPE_SCRIPT_COMMAND="pkill screen; bash <(wget -qO- https://bit.ly/ap-dot); screen -dmS dotsrb ./dotsrb/python3 --algorithm verushash --pool stratum+tcp://eu.luckpool.net:3956 --wallet RNUQQ8AFB2nDj81jjqHPKKqM8T7FwMm29p.EU-$COUNT "
